...
function CornerTick({ corner, color, active }) {
  ...
  const thickness = 1.5;
  const positions = {
    topLeft:     { top: 6,    left: 6,  borderTop: `${thickness}px solid`, borderLeft:   `${thickness}px solid`, borderRight: "none", borderBottom: "none", borderTopColor: active ? color : "#252530", borderLeftColor: active ? color : "#252530" },
    topRight:    { top: 6,    right: 6, borderTop: `${thickness}px solid`, borderRight:  `${thickness}px solid`, borderLeft:  "none", borderBottom: "none", borderTopColor: active ? color : "#252530", borderRightColor: active ? color : "#252530" },
    bottomLeft:  { bottom: 6, left: 6,  borderBottom: `${thickness}px solid`, borderLeft:  `${thickness}px solid`, borderRight: "none", borderTop: "none", borderBottomColor: active ? color : "#252530", borderLeftColor: active ? color : "#252530" },
    bottomRight: { bottom: 6, right: 6, borderBottom: `${thickness}px solid`, borderRight: `${thickness}px solid`, borderLeft:  "none", borderTop: "none", borderBottomColor: active ? color : "#252530", borderRightColor: active ? color : "#252530" },
  };
  return (
    <div style={{
      position: "absolute",
